...
This is a git repository of the source files for the book The Puzzle King
Amusing arithmetic, book-keeping blunders, commercial comicalities, curious "catches", peculiar problems, perplexing paradoxes, quaint questions, queer quibbles, school stories, interesting items, tricks with figures, cards, draughts, dice, dominoes, etc., etc., etc. by John Scott. This book is in the Public Domain, see the LICENSE file for details.
...
Technical details
=================
The main source file for this book will be a file with a name containing `52052` with a file extension (ex. `.txt`, `.rst`, `.tei`, `.tex`). Some books also contain generated ebooks, html versions, and images/figures from the text as image files. Eventually, there will be generated ebooks in the downloads area.
